...
import axios from "axios";// database ayuu xogta kasoo qaadaa front enf ayuu keenaa
...
const AdminProducts = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6 text-indigo-700"> Admin - Manage Products</h1>
